...
// Cafeteria is intentionally split into two rectangles to match walkable geometry.
export const ROOM_REGION_RECTS: NamedRect[] = [
  { name: 'Cafeteria', x: 620, y: 25, w: 700, h: 360 },
  { name: 'Cafeteria', x: 670, y: 5, w: 600, h: 405 },
